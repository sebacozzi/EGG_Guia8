...
public class Menu {
    ...
    private String exit;
    /**
     * variable de bandera para salida de bucle de menu es mantenida por la
     * clase llamante
     */
     ...
     *
     * @param titulo Titulo que va a representar el menu si no se especifica
     * utiliza la pocisión 0 del array items
     * @param items array de String con las opciones principales del menu
     * @param exit texto para indicar el mensaje para la opcion de retorno o
     * salida del menu
     *
     */
     ...
     *
     * @return devuelve un entero mayor que 1.
     */
    ...
    public boolean esSalida() {
        return resultado == items.length + 1;
    }

    public void pausaSiOpcion(int opcionMinimo, int opcionMaximo) {
        if (resultado >= opcionMinimo && resultado <= opcionMaximo) {
            esperaTecla();
        }
    }
